export default {
  ...
  home: {
    ...
    painPoints: {
      ...
      items: {
        expensive: {
          ...
          desc: 'Her ay birikerek artan birden fazla AI aboneliği için ödeme yapmak'
        },
        complex: {
          title: 'Hesap Karmaşası',
          desc: 'Farklı platformlardaki dağınık hesapları ve API key\'leri yönetmek'
        },
        unstable: {
          title: 'Hizmet Kesintileri',
          desc: 'Tek hesapların hız sınırına takılması ve iş akışınızı bozması'
        },
        noControl: {
          title: 'Kullanım Kontrolü Yok',
          desc: "Paranızın nereye gittiğini takip edememek veya ekip üyelerinin kullanımını sınırlayamamak"
        }
      }
    },
    // Solutions section
    solutions: {
      title: 'Bu Sorunları Çözüyoruz',
      subtitle: 'Stressiz AI erişimi için üç basit adım'
    },
    features: {
      unifiedGateway: 'Tek Tıkla Erişim',
      unifiedGatewayDesc: 'Bağlı tüm AI modellerini çağırmak için tek bir API key alın. Ayrı uygulama gerekmez.',
      multiAccount: 'Her Zaman Güvenilir',
      multiAccountDesc: 'Otomatik yük devretme ile birden fazla upstream hesap arasında akıllı yönlendirme.',
      balanceQuota: 'Kullandığın Kadar Öde',
      balanceQuotaDesc: 'Kota sınırlı kullanım bazlı faturalandırma. Ekip tüketimine tam görünürlük.'
    },
    // Comparison section
    comparison: {
      ...
      items: {
        pricing: {
          ...
          official: 'Sabit aylık ücret, kullanmasanız da ödersiniz',
          us: 'Sadece kullandığınız kadar ödeyin'
        },
        models: {
          feature: 'Model Seçimi',
          official: 'Yalnızca tek sağlayıcı',
          us: 'Modeller arasında özgürce geçiş yapın'
        },
        management: {
          feature: 'Hesap Yönetimi',
          official: 'Her hizmeti ayrı ayrı yönetin',
          us: 'Tek key, tek panel'
        },
        stability: {
          feature: 'Kararlılık',
          official: 'Tek hesap hız sınırları',
          us: 'Çoklu hesap havuzu, otomatik yük devretme'
        },
        control: {
    ...
    providers: {
      ...
      description: 'Tek API, Çoklu Seçenek',
    ...
    cta: {
      ...
      description: 'Şimdi kaydolun ve kesintisiz AI erişimini deneyimlemek için ücretsiz deneme kredisi alın',
  ...
  keyUsage: {
    ...
    subtitle: 'Gerçek zamanlı harcama ve kullanım durumunu görüntülemek için API Key\'inizi girin',
    placeholder: 'sk-ant-mirror-xxxxxxxxxxxx',
    query: 'Sorgula',
    querying: 'Sorgulanıyor...',
    privacyNote: 'Key\'iniz tarayıcıda yerel olarak işlenir ve saklanmaz',
    ...
    model: 'Model',
    requests: 'İstekler',
    inputTokens: 'Giriş Token\'ları',
    outputTokens: 'Çıkış Token\'ları',
    cacheCreationTokens: 'Cache Oluşturma',
    cacheReadTokens: 'Cache Okuma',
    cacheWriteTokens: 'Cache Yazma',
    totalTokens: 'Toplam Token',
    cost: 'Maliyet',
    // Status
    quotaMode: 'Key Kota Modu',
    ...
    todayExpires: '(bugün bitiyor)',
    daysLeft: '({days} days)',
    usedQuota: 'Kullanılan Kota',
    resetNow: 'Yakında sıfırlanıyor',
    subscriptionType: 'Abonelik Türü',
    subscriptionExpires: 'Abonelik Bitiş',
    // Usage stat cells
    todayRequests: 'Bugünkü İstekler',
    todayInputTokens: 'Bugünkü Giriş',
    todayOutputTokens: 'Bugünkü Çıkış',
    todayTokens: 'Bugünkü Token',
    todayCacheCreation: 'Bugünkü Cache Oluşturma',
    todayCacheRead: 'Bugünkü Cache Okuma',
    todayCost: 'Bugünkü Maliyet',
    rpmTpm: 'RPM / TPM',
    totalRequests: 'Toplam İstekler',
    totalInputTokens: 'Toplam Giriş',
    totalOutputTokens: 'Toplam Çıkış',
    totalTokensLabel: 'Toplam Token',
    totalCacheCreation: 'Toplam Cache Oluşturma',
    totalCacheRead: 'Toplam Cache Okuma',
    totalCost: 'Toplam Maliyet',
    avgDuration: 'Ort. Süre',
    // Messages
    enterApiKey: 'Lütfen bir API Key girin',
  ...
  common: {
    ...
    noGroupsAvailable: 'Grup mevcut değil',
    unknownError: 'Bilinmeyen hata oluştu',
    saving: 'Kaydediliyor...',
    selectedCount: '({count} selected)',
    refresh: 'Yenile',
    autoRefresh: {
      title: 'Otomatik Yenile',
      enable: 'Otomatik yenilemeyi etkinleştir',
  ...
  nav: {
    ...
    usage: 'Kullanım',
    redeem: 'Kod Kullan',
    affiliate: 'Ortak Komisyonları',
    affiliateManagement: 'Ortak Komisyonları',
    affiliateInviteRecords: 'Davet Kayıtları',
    affiliateRebateRecords: 'Komisyon Kayıtları',
    affiliateTransferRecords: 'Transfer Kayıtları',
    profile: 'Profil',
    users: 'Kullanıcılar',
    groups: 'Gruplar',
    channels: 'Kanallar',
    ...
    buySubscription: 'Yükleme / Abonelik',
    docs: 'Belgeler',
    myOrders: 'Siparişlerim',
    orderManagement: 'Siparişler',
    paymentDashboard: 'Ödeme Paneli',
    paymentConfig: 'Ödeme Ayarları',
    paymentPlans: 'Planlar',
    channelManagement: 'Kanallar',
    channelPricing: 'Kanal Fiyatlandırma',
    channelMonitor: 'Kanal İzleme',
  ...
  auth: {
    ...
    signInToAccount: 'Devam etmek için hesabınıza giriş yapın',
    signIn: 'Giriş Yap',
    signingIn: 'Giriş yapılıyor...',
    createAccount: 'Hesap Oluştur',
    signUpToStart: '{siteName} kullanmaya başlamak için kaydolun',
    signUp: 'Kayıt Ol',
    processing: 'İşleniyor...',
    continue: 'Devam Et',
    ...
    registrationDisabled: 'Kayıt şu an devre dışı. Lütfen yönetici ile iletişime geçin.',
    emailLabel: 'E-posta',
    emailPlaceholder: 'E-posta adresinizi girin',
    passwordLabel: 'Şifre',
    passwordPlaceholder: 'Şifrenizi girin',
    createPasswordPlaceholder: 'Güçlü bir şifre oluşturun',
    ...
    errors: {
      USER_NOT_ACTIVE: 'Hesap devre dışı bırakıldı.',
    },
    ...
    accountCreatedSuccess: '{siteName}\'e hoş geldiniz! Hesabınız başarıyla oluşturuldu.',
    reloginRequired: 'Oturum süresi doldu. Lütfen tekrar giriş yapın.',
    turnstileExpired: 'Doğrulama süresi doldu, lütfen tekrar deneyin',
    turnstileFailed: 'Doğrulama başarısız, lütfen tekrar deneyin',
    ...
    verificationCodeHint: 'E-postanıza gönderilen 6 haneli kodu girin',
    sendingCode: 'Gönderiliyor...',
    sendCode: 'Kod gönder',
    clickToResend: 'Kodu yeniden göndermek için tıklayın',
    resendCode: 'Doğrulama kodunu yeniden gönder',
    sendCodeDesc: "We'll send a verification code to",
    codeSentSuccess: 'Doğrulama kodu gönderildi! Gelen kutunuzu kontrol edin.',
    verifying: 'Doğrulanıyor...',
    verifyAndCreate: 'Verify & Create Account',
    resendCountdown: 'Resend code in {countdown}s',
    backToRegistration: 'Kayda geri dön',
    sendCodeFailed: 'Doğrulama kodu gönderilemedi. Lütfen tekrar deneyin.',
    verifyFailed: 'Doğrulama başarısız. Lütfen tekrar deneyin.',
    codeRequired: 'Doğrulama kodu gerekli',
    invalidCode: 'Lütfen geçerli 6 haneli bir kod girin',
    promoCodeLabel: 'Promosyon Kodu',
    promoCodePlaceholder: 'Promosyon kodu girin (isteğe bağlı)',
  ...
  dashboard: {
    title: 'Panel',
    welcomeMessage: 'Tekrar hoş geldiniz! Hesabınıza genel bakış.',
    balance: 'Bakiye',
    apiKeys: 'API Anahtarları',
    todayRequests: 'Bugünkü İstekler',
    todayCost: 'Bugünkü Maliyet',
    todayTokens: 'Bugünkü Token',
    totalTokens: 'Toplam Token',
    cacheToday: 'Cache (Bugün)',
    performance: 'Performans',
    avgResponse: 'Ort. Yanıt',
    averageTime: 'Ortalama süre',
    timeRange: 'Zaman Aralığı',
    granularity: 'Detay Seviyesi',
    day: 'Gün',
    hour: 'Saat',
    modelDistribution: 'Model Dağılımı',
    groupDistribution: 'Grup Kullanım Dağılımı',
    platformBreakdown: 'Platform Bazlı Dağılım',
    platformBreakdownEmpty: 'Henüz platform kullanımı yok',
    ...
    tokenUsageTrend: 'Token Kullanım Trendi',
    ...
    output: 'Çıkış',
    cache: 'Cache',
    recentUsage: 'Son Kullanım',
    last7Days: 'Son 7 gün',
    noUsageRecords: 'Kullanım kaydı yok',
    startUsingApi: 'Kullanım geçmişinizi görmek için API\'yi kullanmaya başlayın.',
    viewAllUsage: 'Tüm kullanımı görüntüle',
    quickActions: 'Hızlı İşlemler',
    createApiKey: 'API Anahtarı Oluştur',
    generateNewKey: 'Yeni bir API anahtarı oluştur',
    viewUsage: 'Kullanımı Görüntüle',
    checkDetailedLogs: 'Detaylı kullanım kayıtlarını kontrol et',
    redeemCode: 'Kod Kullan',
    addBalanceWithCode: 'Kod ile bakiye ekle'
  },
  ...
  keys: {
    ...
    searchPlaceholder: 'Ad veya key ara...',
    endpoints: {
    ...
    editKey: 'API Anahtarını Düzenle',
    deleteKey: 'API Anahtarını Sil',
    deleteConfirmMessage: "'{name}' anahtarını silmek istediğinizden emin misiniz? Bu işlem geri alınamaz.",
    apiKey: 'API Anahtarı',
    group: 'Group',
    noGroup: 'Grup yok',
    searchGroup: 'Grup ara...',
    noGroupFound: 'Grup bulunamadı',
    created: 'Oluşturuldu',
    copyToClipboard: 'Panoya kopyala',
    copied: 'Copied!',
    importToCcSwitch: 'CCS\'e Aktar',
    enable: 'Etkinleştir',
    disable: 'Disable',
    nameLabel: 'Ad',
    namePlaceholder: 'Benim API Anahtarım',
    groupLabel: 'Grup',
    selectGroup: 'Grup seçin',
    statusLabel: 'Durum',
    selectStatus: 'Durum seçin',
    saving: 'Saving...',
    noKeysYet: 'Henüz API anahtarı yok',
    createFirstKey: 'API ile başlamak için ilk API anahtarınızı oluşturun.',
    keyCreatedSuccess: 'API anahtarı başarıyla oluşturuldu',
    keyUpdatedSuccess: 'API anahtarı başarıyla güncellendi',
    keyDeletedSuccess: 'API anahtarı başarıyla silindi',
    keyEnabledSuccess: 'API anahtarı başarıyla etkinleştirildi',
    keyDisabledSuccess: 'API anahtarı başarıyla devre dışı bırakıldı',
    failedToLoad: 'API anahtarları yüklenemedi',
    failedToSave: 'API anahtarı kaydedilemedi',
    failedToDelete: 'API anahtarı silinemedi',
    ...
    quotaAmount: 'Kota Miktarı',
    quotaAmountPlaceholder: 'Enter quota limit in USD',
    quotaAmountHint: 'Set the maximum amount this key can spend. 0 = unlimited.',
    quotaUsed: 'Kullanılan Kota',
    reset: 'Sıfırla',
    resetQuotaUsed: 'Kullanılan kotayı 0\'a sıfırla',
    resetQuotaTitle: 'Kota Sıfırlamayı Onayla',
    ...
    quotaResetSuccess: 'Kota başarıyla sıfırlandı',
    failedToResetQuota: 'Failed to reset quota',
    rateLimitColumn: 'Hız Sınırı',
    rateLimitSection: 'Rate Limit',
    resetUsage: 'Reset',
    rateLimit5h: '5 Saatlik Sınır',
    rateLimit1d: 'Günlük Sınır',
    rateLimit7d: '7 Günlük Sınır',
    rateLimitHint: 'Set the maximum spending for this key within each time window. 0 = unlimited.',
    rateLimitUsage: 'Hız Sınırı Kullanımı',
    resetRateLimitUsage: 'Hız Sınırı Kullanımını Sıfırla',
    ...
    rateLimitResetSuccess: 'Hız sınırı kullanımı başarıyla sıfırlandı',
    ...
    expiresAt: 'Expires',
    noExpiration: 'Hiçbir zaman',
    status: {
      active: 'Aktif',
      inactive: 'Pasif',
      quota_exhausted: 'Kota Tükendi',
  ...
  usage: {
    ...
    description: 'API kullanım geçmişinizi görüntüleyin ve analiz edin',
    costDetails: 'Maliyet Dağılımı',
    tokenDetails: 'Token Dağılımı',
    ...
    endpoint: 'Uç Nokta',
    endpointDistribution: 'Uç Nokta Dağılımı',
    inbound: 'Inbound',
    upstream: 'Upstream',
    mapping: 'Mapping',
    path: 'Path',
    ...
    original: 'Original',
    billed: 'Billed',
    noRecords: 'Kullanım kaydı bulunamadı. Filtrelerinizi ayarlamayı deneyin.',
    failedToLoad: 'Kullanım kayıtları yüklenemedi',
    noDataToExport: 'No data to export',
    exportSuccess: 'Kullanım verileri başarıyla dışa aktarıldı',
    ...
    tabs: { usage: 'Kullanım', errors: 'Hatalı İstekler' },
    errors: {
  ...
  channelStatus: {
    title: 'Kanal Durumu',
    description: 'Kanal kullanılabilirliğini, gecikmesini ve son durumunu inceleyin',
  ...
  availableChannels: {
    ...
    description: 'Erişebileceğiniz kanallar, desteklenen modeller ve fiyatlandırma',
    searchPlaceholder: 'Kanal veya model ara...',
  ...
  redeem: {
    title: 'Kod Kullan',
    description: 'Bakiye eklemek için kullanım kodunuzu girin',
    currentBalance: 'Mevcut Bakiye',
    concurrency: 'Eş Zamanlılık',
    requests: 'istek',
    redeemCodeLabel: 'Kullanım Kodu',
    redeemCodePlaceholder: 'Kullanım kodunuzu girin',
    redeemCodeHint: 'Kullanım kodları büyük/küçük harf duyarlıdır',
    redeeming: 'Kullanılıyor...',
    redeemButton: 'Kodu Kullan',
    redeemSuccess: 'Kod Başarıyla Kullanıldı!',
    ...
    aboutCodes: 'Kullanım Kodları Hakkında',
    codeRule1: 'Her kod yalnızca bir kez kullanılabilir',
    ...
    pleaseEnterCode: 'Lütfen bir kullanım kodu girin'
  },
  ...
  profile: {
    ...
    concurrencyLimit: 'Eş Zamanlılık Sınırı',
    rpmLimit: 'RPM Sınırı',
    rpmUnlimited: 'Sınırsız',
    memberSince: 'Üyelik Tarihi',
    overviewTitle: 'Hesap Genel Bakışı',
  ...
  // Table
  table: {
    expandActions: 'Daha Fazla İşlem Göster',
    collapseActions: 'İşlemleri Daralt'
  },
